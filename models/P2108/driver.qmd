...
```cmd
# Windows (64-bit)
P2108Driver-1.0.0-Windows-x64.exe -i input.txt -model HGTCM -o output.txt

# macOS
./P2108Driver-1.0.0-Darwin-universal -i input.txt -model HGTCM -o output.txt

# Linux
./P2108Driver-1.0.0-Linux-x86_64 -i input.txt -model HGTCM -o output.txt
```
...
```cmd
# Windows (64-bit)
P2108Driver-1.0.0-Windows-x64.exe -i input.txt -model TSM -o output.txt

# macOS
./P2108Driver-1.0.0-Darwin-universal -i input.txt -model TSM -o output.txt

# Linux
./P2108Driver-1.0.0-Linux-x86_64 -i input.txt -model TSM -o output.txt
```
...
```cmd
# Windows (64-bit)
P2108Driver-1.0.0-Windows-x64.exe -i input.txt -model ASM -o output.txt

# macOS
./P2108Driver-1.0.0-Darwin-universal -i input.txt -model ASM -o output.txt

# Linux
./P2108Driver-1.0.0-Linux-x86_64 -i input.txt -model ASM -o output.txt
```
