...
This page details the installation and usage of the Python version of the PropLib implementation of the Low Frequency / Medium Frequency (IF77) propagation model.
...
pol = IF77.Polarization.Horizontal

# Call the IF77 model
result = IF77.IF77(h_tx__meter, h_rx__meter, f__mhz, P_tx__watt, N_s, d__km, epsilon, sigma, pol)
...
# result.method     is <SolutionMethod.ResidueSeries: 1>
```
