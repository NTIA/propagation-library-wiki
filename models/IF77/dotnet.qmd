...
// IF77.Polarization pol = IF77.Polarization.Horizontal;

// Call the IF77 model
int rtn = IF77.IF77Model(h_tx__meter, h_rx__meter, f__mhz, P_tx__watt, N_s,
    d__km, epsilon, sigma, pol, out IF77.Result result);
...
// result.method     is ITS.Propagation.IF77.SolutionMethod.ResidueSeries
