...
This page details the installation and usage of the C++ version of the Low Frequency / Medium Frequency (LF/MF) Propagation Model, developed by NTIA/ITS.
...
int main() {
    ...
    // Call the model
    rtn = LFMF::LFMF(h_tx__meter, h_rx__meter, f__mhz, P_tx__watt, N_s, d__km, epsilon, sigma, pol, &result);
