...
: Arguments for the Recommendation ITU-R P.2108 command-line driver {#tbl-lfmf-driver-input-args}
...
The LF/MF Propagation Model can be run by simply providing the input and output files on the command line.
For example:
