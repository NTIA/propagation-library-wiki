...
[C++](quick-start/cpp.qmd){.btn .btn-secondary role="button"}
[C#/.NET](quick-start/dotnet.qmd){.btn .btn-secondary role="button"}
[MATLAB](quick-start/matlab.qmd){.btn .btn-secondary role="button"}
[Python](quick-start/python.qmd){.btn .btn-secondary role="button"}
